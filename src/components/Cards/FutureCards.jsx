...
const FutureCards = ({heading, icon, item1, item2, item3}) => {
  return (
    <div className=''>
      ...
      <h1 className='text-white font-semibold text-[22px] md:text-3xl mb-4'>{heading}</h1>
      <ul className='flex flex-col gap-6 ml-4'>
        {item1 && (<li className='text-[#333333] list-disc'>
            <p className='md:text-[18px] lg:text-[20px]'>{item1}</p>
        </li>)}
        {item2 && (<li className='text-[#333333] list-disc'>
            <p className='md:text-[18px] lg:text-[20px]'>{item2}</p>
        </li>)}
        {item3 && (<li className='text-[#333333] list-disc'>
            <p className='md:text-[18px] lg:text-[20px]'>{item3}</p>
        </li>)}
      </ul>
    </div>
  )
