  ...
  return (
    <div className=" bg-[#1B191D] py-16 px-8 rounded-[40px] mb-28 lg:mb-72">
      <div className="flex items-center lg:gap-10 justify-center mb-20">
        <Icon/>
        <h1 className="bg-gradient-to-r from-[#FFFFFF] to-[#8B1FF4] text-transparent bg-clip-text font-bold text-3xl text-center">Web3 requires a UX Revolution</h1>
        <Icon/>
      </div>
      <div className="flex flex-col lg:px-9 lg:flex-row gap-20 lg:gap-32">
